...
//while explicit-defaulted constractor definition within class as Sales_data()=default;
//default constractor with =default keyword.
//Sales_data::Sales_data() { cout << "in default constractor with keyword =default"; }  //error second definition

//Sales_data::Sales_data()=default {cout << "in explici-default constractor." << endl; }
